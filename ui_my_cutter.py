...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon2 = QIcon()
        icon2.addFile(u"images/\u5782\u76f4\u7ffb\u8f6c.png", QSize(), QIcon.Normal, QIcon.Off)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.horizontalSliderSaturation.setToolTip(QCoreApplication.translate("Dialog", u"\u9971\u548c\u5ea6", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.saturation_label.setToolTip(QCoreApplication.translate("Dialog", u"\u9971\u548c\u5ea6", None))
#endif // QT_CONFIG(tooltip)
